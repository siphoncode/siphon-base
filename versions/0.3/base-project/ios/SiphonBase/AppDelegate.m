...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (SP_SUBMISSION_ID) {
        ...
        if (SP_CUSTOM_HOST) {
            appViewController = [[SPDevelopmentAppViewController alloc] initWithAppId:SP_APP_ID andAuthToken:SP_AUTH_TOKEN andDelegate:nil andHost:SP_CUSTOM_HOST sandboxMode:FALSE];
        } else {
            appViewController = [[SPDevelopmentAppViewController alloc] initWithAppId:SP_APP_ID andAuthToken:SP_AUTH_TOKEN];
        }
        self.window.rootViewController = appViewController;
    }    
